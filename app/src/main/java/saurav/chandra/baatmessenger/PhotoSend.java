...
public class PhotoSend extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent2= new Intent(PhotoSend.this, Chat.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent3= new Intent(PhotoSend.this,CameraActivity.class);
