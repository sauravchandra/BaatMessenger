...
import saurav.chandra.baatmessenger.emoji.Nature;
import saurav.chandra.baatmessenger.emoji.Objects;
import saurav.chandra.baatmessenger.emoji.People;
import saurav.chandra.baatmessenger.emoji.Places;
import saurav.chandra.baatmessenger.emoji.Symbols;
...
public class EmojiconsPopup extends PopupWindow implements ViewPager.OnPageChangeListener, EmojiconRecents {
	...
	public EmojiconsPopup(View rootView, Context mContext){
		...
		//default size 
		setSize((int) mContext.getResources().getDimension(R.dimen.keyboard_height), LayoutParams.FILL_PARENT);
	}
	/**
		...
		rootView.getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
			...
			public void onGlobalLayout() {
				...
				if (heightDifference > 100) {
					...
					setSize(LayoutParams.FILL_PARENT, keyBoardHeight);
					if(!isOpened){
